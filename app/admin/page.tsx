...
export default function AdminDashboard() {
  ...
  return (
    // Fixed Top Padding (pt-28 / pt-32) so Header doesn't overlap content
    <main className="min-h-screen bg-[#f5f2eb] pt-32 pb-16 px-6 md:px-12 text-[#1a1a1a]">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        {/* Main Content Grid: Upcoming Shoots (Left) & Quick Actions (Right) */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          
          {/* Upcoming Shoots - Takes 2 Columns */}
          ...
          {/* Quick Actions Panel - Positioned cleanly on the Right */}
